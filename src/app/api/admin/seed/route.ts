...
const SEED_MAP: SeedEntry[] = [
  ...
  // DEPORTES
  { category: "deportes", subcategory: "relojes-dep",  label: "Relojes Deportivos",        query: "sport watch GPS outdoor",              tag: "bestseller", keywords: ["sport watch","gps watch","running watch","multisport","outdoor watch","swim watch","triathlon","cycling watch"] },
  { category: "deportes", subcategory: "sensores-dep", label: "Sensores de Entrenamiento", query: "fitness sensor jump rope smart",        tag: "oferta",     keywords: ["sensor","jump rope","calorie","speed sensor","cadence","heart rate","fitness sensor","training sensor","skip rope"] },
  { category: "deportes", subcategory: "ropa-smart",   label: "Ropa Inteligente",          query: "smart sport compression wearable",     tag: "nuevo",      keywords: ["smart clothing","sensor suit","wearable sport","smart jersey","compression smart","sport sensor","biometric clothing"] },
